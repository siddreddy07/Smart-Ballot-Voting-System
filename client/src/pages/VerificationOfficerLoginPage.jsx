...
export default function VerificationOfficerLogin() {
  const navigate = useNavigate();
  const { vuser, loginVerificationOfficer } = useVerificationOfficer();
  ...
  // Check if form is valid: both email and password are non-empty
  ...
  const handleSubmit = async () => {
    ...
    const success = await loginVerificationOfficer(
      {
        EMAIL: email,
        PASSWORD: password,
      },
